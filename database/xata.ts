...
const tables = [
  {
    ...
    columns: [
      ...
      { name: "clientCategories", type: "multiple" },
    ],
    revLinks: [
      ...
      { column: "userId", table: "clients" },
      { column: "userId", table: "user_funnel_health" },
      { column: "user", table: "profile" },
    ],
  },
  {
  ...
  {
    name: "user_funnel_health",
    columns: [
      { name: "companyName", type: "text" },
      { name: "companyId", type: "int" },
      { name: "screeningStage", type: "int" },
      { name: "submissionStage", type: "int" },
      { name: "firstInterviewStage", type: "int" },
      { name: "finalInterviewStage", type: "int" },
      { name: "offerStage", type: "int" },
      { name: "predictedHires", type: "int" },
      { name: "talentPoolToPreScreening", type: "float" },
      { name: "shortlistedToSubmission", type: "float" },
      { name: "interviewToOffer", type: "float" },
      { name: "offerToHire", type: "float" },
      { name: "userId", type: "link", link: { table: "nextauth_users" } },
      { name: "talentPoolStage", type: "int" },
      { name: "preScreeningStage", type: "int" },
      { name: "connectedStage", type: "int" },
      { name: "hiredStage", type: "int" },
    ],
  },
  {
    name: "profile",
    columns: [
      ...
      { name: "hiresTarget", type: "int", defaultValue: "3" },
    ],
  },
] as const;
...
export type UserFunnelHealth = InferredTypes["user_funnel_health"];
export type UserFunnelHealthRecord = UserFunnelHealth & XataRecord;
...
export type DatabaseSchema = {
  ...
  user_funnel_health: UserFunnelHealthRecord;
